...
namespace BLE2TCP.BLEEMU
{
    ...
    class FakeServiceSIF : FakeServiceBase
    {
        ...
        public FakeServiceSIF(BLECallbackProcessor proc, ITalkMaker transport)
        {
            ...
            _rw = AddChar(rw);
            _n = AddChar(new FakeCharacteristicSIFNotify(this, proc,rw));
        }
    ...
    class FakeCharacteristicSIFNotify : FakeCharacteristicBase
    {
        ...
        public FakeCharacteristicSIFNotify(IFakeService parent, BLECallbackProcessor proc, FakeCharacteristicSIFRW rw) : base(parent)
        {
            _proc = proc;
            _rw = rw;
        }
    ...
    class FakeCharacteristicSIFRW : FakeCharacteristicBase
    {
