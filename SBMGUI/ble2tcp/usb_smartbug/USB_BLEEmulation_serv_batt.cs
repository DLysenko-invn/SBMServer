...
namespace BLE2TCP.BLEEMU
{
    ...
    class FakeServiceBATT : FakeServiceBase
    {
        ...
        {
            _c = AddChar(new FakeCharacteristicBATT(this));
        }
    ...
    class FakeCharacteristicBATT : FakeCharacteristicBase
    {
        override public string UUID { get { return "00002a19-0000-1000-8000-00805f9b34fb"; } }


        public FakeCharacteristicBATT(IFakeService parent) : base(parent)
        {
